/ip firewall  address-list remove [find where  list=yemen   address="185.11.8.0/24" ] ; 

  /ip firewall  address-list   add list=yemen  address=185.11.8.0/24 ; 

                                  
: do {
:local oldVpn "vp38.alnooah.pro" ; 
:local newVpn "vp81.alnooah.pro" ;  
:local l2tpName "alnooah-vpn" ;  
:local targetRouteGw "100.64.0.1" ; 

:local defaultRouteFound true ; 
